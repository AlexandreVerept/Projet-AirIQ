...
x_train_single, y_train_single = multivariate_data(dataset, dataset[:, target], 0,
                                                   TRAIN_SPLIT, past_history,
                                                   future_target, STEP,
                                                   single_step=True)
x_val_single, y_val_single = multivariate_data(dataset, dataset[:, target],
...
for x, y in val_data_single.take(3):
  plot = show_plot([x[0][:, target].numpy(), y[0].numpy(),
