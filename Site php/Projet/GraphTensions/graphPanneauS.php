...
valueAxis.title.text = "Tension du panneau solaire (en V)";

//Créer différentes courbes avec la fonction "series"
let series = chart.series.push(new am4charts.LineSeries());
series.dataFields.dateX = "time";
series.dataFields.valueY = "PanneauS";
series.tooltipText = "Tension du panneau solaire: [bold]{valueY}[/]";
...
<?php
  ...
  $bbd = connexion();
    try{
      // On récupère les données de la Ruche dans la BDD
      if(isset($_GET["ruche"])){
        $ruche = $_GET["ruche"];
