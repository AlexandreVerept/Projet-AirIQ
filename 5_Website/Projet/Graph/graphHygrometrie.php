...
valueAxis.title.text = "Hygrométries (en %)";

//Créer différentes courbes avec la fonction "series"
let series = chart.series.push(new am4charts.LineSeries());
series.dataFields.dateX = "time";
series.dataFields.valueY = "HygroInt";
series.tooltipText = "Hygrométrie à l'intérieur de la ruche: [bold]{valueY}[/]";
series.fillOpacity = 0.3;

let series2 = chart.series.push(new am4charts.LineSeries());
series2.dataFields.dateX = "time";
series2.dataFields.valueY = "HygroExt";
series2.tooltipText = "Hygrométrie à l'extérieur de la ruche: [bold]{valueY}[/]";
...
<?php
  ...
  try{
    ...
    $sql_query="SELECT HygroInt, HygroExt, time  FROM `RecuperationDonnees` WHERE NumRuche=".$ruche ;    // Requête
